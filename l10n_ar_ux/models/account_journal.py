...
class AccountJournal(models.Model):
    ...
    l10n_ar_document_type_ids = fields.Many2many('l10n_latam.document.type',
    ...
    def _get_l10n_ar_afip_pos_types_selection(self):
        """ Add more options to the selection field AFIP POS System, 
            re order options by common use """
    ...
    def _check_afip_pos_number(self):
        return super(AccountJournal, self.filtered(
            lambda x: x.l10n_ar_afip_pos_system != 'not_applicable'))\
