...
class ResConfigSettings(models.TransientModel):
    ...
    group_include_pending_receivable_documents = fields.Boolean(
        ...
        help="Si marca esta opción, cuando se imprima o envíe un Recibo de "
        "Clientes, se incluirá una sección con todos los Comprobantes "
        "abiertos, es decir, que tengan algún saldo pendiente")