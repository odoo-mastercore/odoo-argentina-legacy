...
class AccountInvoiceReport(models.Model):
    ...
    # por ahora no lo agregamos, el que teniamos ya era en moneda de cia 
    # y basicamente el nuevo price_subtotal ya lo hace
    # price_subtotal_signed = fields.Monetary(
    #     'Subtotal (Inv. Currency)', help='Subtotal amount on invoice currency 
    #       and signed (refunds are negative)',
